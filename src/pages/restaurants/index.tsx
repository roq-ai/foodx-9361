...
export function RestaurantListPage(props: RestaurantListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getRestaurants({
        relations: ['user', 'delivery_order.count', 'menu_item.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('delivery_order', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'delivery_order',
          header: 'Delivery Order',
          accessorKey: 'delivery_order',
          cell: ({ row: { original: record } }: any) => record?._count?.delivery_order,
        }
      : null,
