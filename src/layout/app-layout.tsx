...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiCoffee, FiTruck } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Menu Items', path: '/menu-items', entity: 'menu_item', service: AccessServiceEnum.PROJECT, icon: FiMenu },
